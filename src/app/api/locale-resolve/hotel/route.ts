 ...
 * matching hotel, or null if no translation exists in that locale.
 *
 * Consumed by LocaleSwitcher's resolveLocalizedPathname() on language
 * pick from a /hotels/[slug] page.
 */

const lookupQuery = `*[_type == "hotel" && (
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.error('[locale-resolve] hotel fetch failed:', err);
