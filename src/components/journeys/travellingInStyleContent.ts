...
export const travellingInStyleContent: LocalizedJourney = {
  ...
  ja: {
    ...
    essay: [
      ...
      'そのすべての下を、気づかれるべきでない振り付けが流れています。航空機の扉での出迎え、ひとりでに移動する荷物、すでに涼しい車、下請けの約束ではなく各都市にいる私たち自身の人間。この国の地上を30年動かしてきたことが、このページ全体が載っている飾り気のない資産であり、どんな写真にも写らない部分です。',
      [
