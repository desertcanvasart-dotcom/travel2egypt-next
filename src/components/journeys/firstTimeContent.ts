...
export const firstTimeContent: LocalizedJourney = {
  ...
  // JA — re-authored per the corpus conventions (journeys-ja-first-time-in-
  // egypt.md v1, owner-locked; may later receive a native-speaker pass — until
  // then verbatim, including the —— dashes and 「」 quotes). HARD DEPENDENCY:
  // the html[lang='ja'] .journey-doc type-pass in journeys.css (same build) —
  // the masthead <em> renders UPRIGHT Noto Serif JP, same weight/color/size.
  // Wiring rule (standing convention): always the JA Sanity slug when it
  // exists (avoids the EN-slug 308 hop). operatorNote.label is the JA literal,
  // matching OPERATOR_NOTE_LABELS.ja.honest. crossRef linkText drops the
  // sentence-final 。 because the component appends ' →' (same treatment as
  // EN/ES, whose linkText carries no terminal period).
  ja: {
    meta: {
      title: 'はじめてのエジプト',
      description:
        'カイロ、アスワンとルクソールのあいだの川、何を入れて何を二度目に残すか。初めてのエジプトの組み立て方と、順序がリストより大事な理由。',
    },

    masthead: {
      eyebrow: '旅の始まり · はじめてのエジプト',
      headlineLead: 'エジプトは五千年、この自己紹介を練習してきた。',
      headlineAccent: 'こちらが急ぐ理由は、どこにもない。',
      standfirst:
        'カイロ、ナイル、ルクソール、アスワン——ほとんどの初回の旅がたどるべき弧と、ほとんどの旅が間違える速度。初めてのエジプトを、私たちはこう組み立てます。何を入れ、何を二度目に残し、なぜ順序がリストより大事なのか。',
    },

    essay: [
      '週に何度も依頼される「初めてのエジプト」の定番があります。カイロ一泊、夜明けの南行き便、川沿いで一日に神殿四つ、そしてアブ・シンベルは半日の用事として押し込まれる。紙の上では、すべてを見ています。実際には、ほとんど何も経験していません。そして持ち主は、暑さとは関係のない疲れを抱えて帰国します。',
      'ですからまず、仕事上の原則をひとつ。初めての旅は、棚卸しではありません。エジプトは一度の訪問で抱えきれる以上のものを持っています——それは単なる事実で、そうでないふりをするところから旅程は狂い始めます。初めての旅の仕事はひとつだけ。本質の物語を、正しい順序で、染み込む速度で語ることです。',
      '本質の物語は、川に沿って流れています。始まりはカイロ——ギザの台地、これから訪ねる墓の副葬品が実際に収められている博物館の展示室、そして街の音を覚える最初の夜。次に上エジプト。アスワンとルクソールに挟まれたナイルの一区間に、フィラエ、コム・オンボ、エドフ、カルナック、王家の谷が、急がない数日分の距離で収まっています。この弧——カイロと川——が、初めての旅です。きちんと語るには8日から10日が要ります。6日に圧縮することもできますが、その圧縮が何を削るかは、はっきりお伝えします。',
      '残りのすべては、ふたつの決断で決まります。',
      'ひとつめはカイロです。ほとんどの旅程はカイロに一日しか与えません。ピラミッドが午前中の仕事のように写真に収まるからです。実際は違います。台地だけで急がない半日、博物館にもう半日、そして街——この記念碑群のかたわらに千七百万人が暮らしている理由——に、少なくとも一晩。私たちはカイロに丸二日を置きます。二日目を悔やんだ旅行者には、めったに会いません。',
      'ふたつめは順序です。定番のルートはカイロに降り立ち、足早に片付けて、ルクソールへ飛びます。私たちはしばしば逆にします。カイロの数日のあと、アスワンへ——エジプトのナイルでいちばん穏やかな街へ飛び、そこから船で川を下ってルクソールの密度へ向かう。まだ旅に体が馴染まないうちに、アスワンは川のいちばん静かな姿を見せてくれます。花崗岩の島々、ヌビアの村、エンジンを持たないファルーカ。単位面積あたりの古代エジプトが地上でもっとも濃いルクソールは、神殿を撮る場所ではなく読む場所だと分かってから会うほうがいい街です。始点ではなく終点に置くことで、同じ神殿が別のものに見えてきます。',
      'ふたつの街のあいだは、船で。アスワンとルクソールを結ぶ3泊か4泊の航行は、初めての旅の中盤への、いまも最良の答えです。デッキチェアのためではありません。この区間の神殿は水から近づくために建てられており、設計どおりの近づき方をすることの違いは、気づくというより、感じるものだからです。',
      'そして、計画のいちばん難しい半分——何を外すか。アレクサンドリア、白砂漠、シナイ、修道院群、中部エジプトの彩色墳墓。すべて実在し、どれも普通の長さの初回の旅には収まりません。時間を割く価値がないからではなく、初めての旅が割ける以上の時間に値するからです。エジプトは、戻ってくる旅行者に報いる国です。私たちはその事実のまわりに、旅のつくり方そのものを組み立ててきました。ふたたび来るときの自分に、何かを残しておいてください。',
    ],

    operatorNote: {
      label: '正直な所見',
      body: '手直しを頼まれる初回旅程の多くは、同じ欠点を抱えています。カイロが一日足りず、それ以外のすべてで一箇所ずつ多い。昼食のあとに神殿が三つ並んでいるなら、その計画は、注意力という口座の残高を超えた小切手を切っています。一日に、要となる訪問はふたつまで。午後はプールと、デッキと、スークのものです——失われた時間ではありません。午前が沈殿していく場所です。',
    },

    spine: {
      heading: '旅のかたち',
      rows: [
        { label: '日数', value: 'きちんと語るなら8〜10日。7日でも組めますが、何を削るかはお伝えします' },
        { label: '弧', value: 'カイロ · アスワン · 川 · ルクソール' },
        { label: '速度', value: '要となる訪問は一日ふたつ。午後は、意図して空けてあります' },
        { label: '季節', value: '10月から4月が、エジプトのいちばん優しい季節。夏も川の上なら、早起きと正直な計画で成り立ちます' },
        { label: '向いている人', value: 'チェックリストの消化ではなく、本質の物語をきちんと聞きたい旅行者' },
        { label: '始まり方', value: 'カイロのコンシェルジュとの会話から。決済画面からではありません' },
      ],
    },
    ...
    weave: {
      ...
      items: [
        {
          label: 'カイロとナイル、10日間のプライベート・パッケージ',
          href: '/nairudorima-10-nichikan-kairo-asuwan-nairu-gawa-kuruzu',
          sentence: 'このページが描いてきたルートを、私たちが主張してきた速度のまま、プライベートで。',
        },
        {
          label: 'カイロのガイド',
          href: '/guide/kairo',
          sentence: '二日が私たちの最低ライン。その二日に何が入るのか、そして台地の先で街が何を求めてくるのか。',
        },
        {
          label: 'ルクソールのガイド',
          href: '/guide/rukusoru',
          sentence: '地上でもっとも濃い古代の風景。三つめの墓で感覚が麻痺しないための歩き方。',
        },
        {
          label: 'ナイル川クルーズ',
          href: '/nile-cruises',
          sentence: '実際にお客様を乗せている船だけを。帆走のダハビーヤから大型船まで、選び方とともに。',
        },
      ],
    },
    ...
    journal: {
      ...
      card: {
        ...
        href: '/blog/hitonami-ga-kuru-mae-no-giza-daichi',
      },
    },

    close: {
      heading: '私たちが計画する初めての旅は、みな同じ始まり方をします。',
      body: '日付や手付金からではなく、エジプトをどんな旅にしたいかという会話から。コンシェルジュに「初めてです」とだけ伝えてください。大事な質問は向こうがします。順番は、あなたに合わせて。答えのなかから、計画がかたちを取り始めます。',
      ctaLabel: '会話から始める',
      ctaHref: '/plan-your-tour',
    },
