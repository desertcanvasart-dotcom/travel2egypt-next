...
const MAP: Array<{ sanity: string; corpus: string }> = [
  { sanity: 'abu-simbel-temples-day-tour', corpus: 'private-tour-abu-simble-by-bus-from-aswan' },
  { sanity: '10-days-eternal-egypt-tour', corpus: '10-days-unforgettable-egypt-tour' },
];
