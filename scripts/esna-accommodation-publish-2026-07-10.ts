/** Publish the owner-approved Esna Stage A+B reframe draft (wp-page-59607). */
...
async function main() {
  ...
  writeFileSync('backups/esna-accommodation-publish-rollback-2026-07-10.json', JSON.stringify(pub, null, 2));
