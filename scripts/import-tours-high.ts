...
const MAP: Array<{ sanity: string; corpus: string }> = [
  { sanity: 'mount-sinai-sunrise-trek', corpus: 'mount-sinai-sunrise-trek-group-day-tour' },
  { sanity: 'dendera-and-abydos-temples-tour-from-safaga', corpus: 'dendera-and-abydos-temples-day-tour' },
  { sanity: 'memphis-saqqara-citadel-khan-tour', corpus: 'private-tour-memphis-saqqara-citadel-and-khan-el-khalili-bazaar' },
  { sanity: 'grand-islamic-cairo-day-tour', corpus: 'the-grand-islamic-day-tour' },
  { sanity: 'luxor-2-day-tour-by-plane-from-cairo', corpus: '02-day-luxor-tour-by-plane-from-cairo' },
  { sanity: 'snorkeling-sea-trip-in-sharm-el-sheikh', corpus: 'diving-sea-trip-in-sharm-el-sheikh' },
];
