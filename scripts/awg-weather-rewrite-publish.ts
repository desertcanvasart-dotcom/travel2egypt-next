...
async function main() {
  ...
  const path = 'backups/awg-weather-pre-rewrite-2026-07-11.json';
  ...
  console.log('verify body en/es/ja=', ['en','es','ja'].map(l=>(g(now.body,l)||[]).length).join('/'), '| draft gone=', !dr);
